...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><i class='fas fa-cloud-upload-alt'></i> Upload Documents</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-md-12 mb-3">
                    <div class="card card-primary card-outline">
                        <div class="card-header border-bottom-0">
                            <h5><i class='fas fa-cloud-upload-alt'></i> {{$documentType->document_type->name}}</h5>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ url('profile/documents/upload') }}" class="alert border dropzone" id='dropzone'>
                                @csrf
                                <input type='hidden' name='document_type_id' id='doc{{$documentType->document_type->id}}' value='{{$documentType->document_type->id}}'>
                        ...
                        <div class='card-footer bg-white'>
                            <div class='row'>
                                <div class='col'>
                                    <a href='{{$prev_id != 0?url('documents/upload/'.$prev_id):"#"}}' {{$prev_id != 0?"":"disabled"}} class='btn btn-outline-primary btn-sm'> <i class='fas fa-angle-left'></i>&nbsp;Prev</a>
                                </div>
                                <div class='col text-end'>
                                    <a href='{{$next_id != 0?url('documents/upload/'.$next_id):"#"}}' {{$next_id != 0?"":"disabled"}} class='btn btn-outline-primary btn-sm'>Next&nbsp;<i class='fas fa-angle-right'></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
